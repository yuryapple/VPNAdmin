<html lang="en">
  <head>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<div class = "row  page-header">
						...
						<!-- Name of current page	and total user in BD -->
						<div  class="col-sm-10">
						 <h2>
							<span class="label label-info">Users
								<span class="badge" id="totalUsers"> 
									<?php
									  echo  $this->_totalUsers;
									?>
								</span>
							</span>
						 </h2>
    ...
    <script src="/utilites/bootstrap/js/ie10-viewport-bug-workaround.js"></script>
		...
		<script type="text/javascript" src="/javaScript/usersPage.js"></script>
